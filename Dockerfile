...
RUN curl -L https://github.com/ginuerzh/gost/releases/download/v2.12.0/gost_2.12.0_linux_${TARGETARCH}.tar.gz -o gost.tar.gz && tar -xzf /app/gost.tar.gz && chmod +x /app/gost
